...
void V8DATE2PSTIME(PS_TIME* d,v8::Handle<Value> dateVal)
{
	...
	v8::Local<v8::Date> number = v8::Local<v8::Date>::Cast(dateVal);	
...
Handle<Value> PSTIME2V8DATE(PS_TIME d)
{
	...
	return v8::Date::New(isolate,(double)(d.Second)*1000+d.Millisec%1000);
}
...
Local<Object> getRealObj(PS_DATA *psData)
{
	...
	case PSDATATYPE_DOUBLE:
	case PSDATATYPE_FLOAT:
		robj->Set(String::NewFromUtf8(isolate,"value"),Number::New(isolate,PS_VARIANT2DOUBLE(psData->Value)));
		break;
	case PSDATATYPE_INT8 :
	case PSDATATYPE_INT16 :
	case PSDATATYPE_INT32 :	
	case PSDATATYPE_INT64 :
		robj->Set(String::NewFromUtf8(isolate,"value"),Int32::New(isolate,PS_VARIANT2INT(psData->Value)));
		break;
		//robj->Set(String::NewFromUtf8(isolate,"value"),)
	case PSDATATYPE_UINT64 :
	case PSDATATYPE_UINT8 :
	case PSDATATYPE_UINT32 :
	case PSDATATYPE_UINT16 :
		robj->Set(String::NewFromUtf8(isolate,"value"),Uint32::New(isolate,PS_VARIANT2UINT(psData->Value)));
		break;
	case PSDATATYPE_BOOL: 
		robj->Set(String::NewFromUtf8(isolate,"value"),Boolean::New(isolate,psData->Value.Bool));
		break;
	case PSDATATYPE_TIME :
		robj->Set(String::NewFromUtf8(isolate,"value"),PSTIME2V8DATE(psData->Value.Time));
		break;
	case PSDATATYPE_STRING:
	case PSDATATYPE_WSTRING:
		{
			robj->Set(String::NewFromUtf8(isolate,"value"),String::NewFromUtf8(isolate,GBK2UTF8(psData->Value.String.Data).c_str()));
		}
		
		break;
	case PSDATATYPE_BLOB: 
		robj->Set(String::NewFromUtf8(isolate,"value"),Undefined(isolate));
		break;
	case DEFAULT:
		robj->Set(String::NewFromUtf8(isolate,"value"),Undefined(isolate));
	}
	robj->Set(String::NewFromUtf8(isolate,"quality"),Uint32::New(isolate,psData->Quality));
	robj->Set(String::NewFromUtf8(isolate,"time"),PSTIME2V8DATE(psData->Time));
	return robj;
}
...
Local<Object> getpropValue(PS_VARIANT *val,Local<Object> robj)
{
	...
	case PSDATATYPE_DOUBLE:
	case PSDATATYPE_FLOAT:
		robj->Set(String::NewFromUtf8(isolate,"value"),Number::New(isolate,PS_VARIANT2DOUBLE(*val)));
		break;
	case PSDATATYPE_INT8 :
	case PSDATATYPE_INT16 :
	case PSDATATYPE_INT32 :	
	case PSDATATYPE_INT64 :
		robj->Set(String::NewFromUtf8(isolate,"value"),Int32::New(isolate,PS_VARIANT2INT(*val)));
		break;
	case PSDATATYPE_UINT64 :
	case PSDATATYPE_UINT8 :
	case PSDATATYPE_UINT32 :
	case PSDATATYPE_UINT16 :
		robj->Set(String::NewFromUtf8(isolate,"value"),Uint32::New(isolate,PS_VARIANT2UINT(*val)));
		break;
	case PSDATATYPE_BOOL: 
		robj->Set(String::NewFromUtf8(isolate,"value"),Boolean::New(isolate,val->Bool));
		break;
	case PSDATATYPE_TIME :
		robj->Set(String::NewFromUtf8(isolate,"value"),PSTIME2V8DATE(val->Time));
		break;
	case PSDATATYPE_STRING:
	case PSDATATYPE_WSTRING:
		{
			robj->Set(String::NewFromUtf8(isolate,"value"),String::NewFromUtf8(isolate,GBK2UTF8(val->String.Data).c_str()));
		}
		break;
	case PSDATATYPE_BLOB: 
		robj->Set(String::NewFromUtf8(isolate,"value"),Undefined(isolate));
...
Local<Object> getPropObj(PS_TAG_PROP_LIST *var,Local<Array> arr)
{
	...
	for (int i=0;i<len;i++)
	{
		...
		case PSDATATYPE_DOUBLE:
		case PSDATATYPE_FLOAT:
			robj->Set(String::NewFromUtf8(isolate,idStr),Number::New(isolate,var->PropValues[i].Double));
			break;
		case PSDATATYPE_INT8 :
		case PSDATATYPE_INT16 :
		case PSDATATYPE_INT32 :	
		case PSDATATYPE_INT64 :
			robj->Set(String::NewFromUtf8(isolate,idStr),Int32::New(isolate, var->PropValues[i].Int32));
			break;
		case PSDATATYPE_UINT64 :
		case PSDATATYPE_UINT8 :
		case PSDATATYPE_UINT32 :
		case PSDATATYPE_UINT16 :
			robj->Set(String::NewFromUtf8(isolate,idStr),Uint32::New(isolate,var->PropValues[i].UInt32));
			break;
		case PSDATATYPE_BOOL: 
			robj->Set(String::NewFromUtf8(isolate,idStr),Boolean::New(isolate,var->PropValues[i].Bool));
			break;
		case PSDATATYPE_TIME :
			robj->Set(String::NewFromUtf8(isolate,idStr),PSTIME2V8DATE(var->PropValues[i].Time));
			break;
		case PSDATATYPE_STRING:
		case PSDATATYPE_WSTRING:
			robj->Set(String::NewFromUtf8(isolate,idStr),String::NewFromUtf8(isolate,GBK2UTF8(var->PropValues[i].String.Data).c_str()));
			break;
		case PSDATATYPE_BLOB: 
			robj->Set(String::NewFromUtf8(isolate,idStr),Undefined(isolate));
			break;
		case DEFAULT:
			robj->Set(String::NewFromUtf8(isolate,idStr),Undefined(isolate));
		}
