    ...
    "remoteMethod":{
        ...
        "login3":class{
            ...
            serilize(jsonObj){
                ...
                let appName = Buffer.from("UAServer");
                let appNameLen = Buffer.alloc(4);
                appNameLen.writeUInt32LE(appName.length,0);
                let appType = Buffer.alloc(4);
                appType.writeUInt32LE(87,0);//应用程序类型 0用户编写的应用程序 87Ex组件，OPCServer、ODBCRouter
